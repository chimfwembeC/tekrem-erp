...
export default function Create({ instructors, categories }: Props) {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter the basic details for the training program
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Set the training schedule and logistics details
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Define the training content and requirements
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
            ...
            <div className="flex justify-end gap-4">
              <Button type="button" variant="outline" asChild>
                <a href={route('hr.training.index')}>Cancel</a>
              </Button>
              <Button type="submit" disabled={processing}>
                <Save className="h-4 w-4 mr-2" />
                {processing ? 'Creating...' : 'Create Training Program'}
              </Button>
            </div>
          </form>
        </div>
