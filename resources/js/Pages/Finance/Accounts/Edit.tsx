...
export default function Edit({ account, accountTypes, currencies }: Props) {
  ...
  return (
    <AppLayout title={t('finance.edit_account', 'Edit Account')}>
      <Head title={t('finance.edit_account', 'Edit Account')} />
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">
              {t('finance.edit_account', 'Edit Account')}
            </h1>
            <p className="text-muted-foreground">
              {t('finance.edit_account_description', 'Update the details for this account')}
            </p>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t('finance.initial_balance_note', 'Changing this will recalculate the current balance')}
                  </p>
                </div>
              ...
              <div className="flex items-center gap-4 pt-6 border-t">
                <Button type="submit" disabled={processing}>
                  ...
                  {processing ? t('common.updating', 'Updating...') : t('finance.update_account', 'Update Account')}
                </Button>
                ...
                <Button type="button" variant="outline" asChild>
                  <Link href={route('finance.accounts.show', account.id)}>
                    {t('common.view', 'View Account')}
                  </Link>
                </Button>
              </div>
            </form>
